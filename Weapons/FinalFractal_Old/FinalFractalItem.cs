...
namespace FinalFractalSet.Weapons.FinalFractal_Old
{
    ...
    public class FinalFractalItem : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (Right)
            {
                ...
                if (illusionBoundPlayer.usedFinalFractal)
                {
                    if (illusionBoundPlayer.finalFractalTier == 1)
                    {
                        ...
                        if (illusionBoundPlayer.usingFinalFractal != 0)
                        {
                            if (useDegree > 0.95f)
                            {
                                spriteBatch.Draw(ModAsset.FinalFractalSwoosh_1.Value, Player.Center + new Vector2(0, -16) - Main.screenPosition, new Rectangle(324, 0, 162, 98), Color.White, 0, new Vector2(81, 49), 1f, spriteEffects, 0);
                            }
                            else if (useDegree > 0.8f)
                            {
                                spriteBatch.Draw(ModAsset.FinalFractalSwoosh_1.Value, Player.Center + new Vector2(0, -16) - Main.screenPosition, new Rectangle(162, 0, 162, 98), Color.White, 0, new Vector2(81, 49), 1f, spriteEffects, 0);
                            }
                            else if (useDegree > 0.6f)
                            {
                                spriteBatch.Draw(ModAsset.FinalFractalSwoosh_1.Value, Player.Center + new Vector2(0, -16) - Main.screenPosition, new Rectangle(0, 0, 162, 98), Color.White, 0, new Vector2(81, 49), 1f, spriteEffects, 0);
                            }
                        }
                    ...
                    if (illusionBoundPlayer.finalFractalTier == 2)
                    {
                        ...
                        if (illusionBoundPlayer.usingFinalFractal != 0)
                        {
                            if (useDegree > 0.66f)
                            {
                                spriteBatch.Draw(ModAsset.FinalFractalSwoosh_2.Value, Player.Center + new Vector2(48, 0) - Main.screenPosition, new Rectangle(160, 0, 80, 38), Color.White, 0, new Vector2(40, 19), 1f, spriteEffects, 0);
                            }
                            else if (useDegree > 0.33f)
                            {
                                spriteBatch.Draw(ModAsset.FinalFractalSwoosh_2.Value, Player.Center + new Vector2(48, 0) - Main.screenPosition, new Rectangle(80, 0, 80, 38), Color.White, 0, new Vector2(40, 19), 1f, spriteEffects, 0);
                            }
                            else if (useDegree > 0.1f)
                            {
                                spriteBatch.Draw(ModAsset.FinalFractalSwoosh_2.Value, Player.Center + new Vector2(48, 0) - Main.screenPosition, new Rectangle(0, 0, 80, 38), Color.White, 0, new Vector2(40, 19), 1f, spriteEffects, 0);
                            }
                        }
                    }
                    if (illusionBoundPlayer.finalFractalTier == 0)
                    {
                        ...
                        if (illusionBoundPlayer.usingFinalFractal != 0)
                        {
                            if (useDegree > 0.66f)
                            {
                                spriteBatch.Draw(ModAsset.FinalFractalSwoosh_3.Value, Player.Center + new Vector2(64, 0) - Main.screenPosition, new Rectangle(180, 0, 90, 22), Color.White, 0, new Vector2(45, 11), 1f, spriteEffects, 0);
                            }
                            else if (useDegree > 0.33f)
                            {
                                spriteBatch.Draw(ModAsset.FinalFractalSwoosh_3.Value, Player.Center + new Vector2(64, 0) - Main.screenPosition, new Rectangle(90, 0, 90, 22), Color.White, 0, new Vector2(45, 11), 1f, spriteEffects, 0);
                            }
                            else if (useDegree > 0.1f)
                            {
                                spriteBatch.Draw(ModAsset.FinalFractalSwoosh_3.Value, Player.Center + new Vector2(64, 0) - Main.screenPosition, new Rectangle(0, 0, 90, 22), Color.White, 0, new Vector2(45, 11), 1f, spriteEffects, 0);
                            }
                        }
                    }
                }
                else
                {
                    ...
                    spriteBatch.Draw(TextureAssets.Projectile[projectile.type].Value, Player.Center + new Vector2(-6, 6) + Vector2.UnitY * Player.gfxOffY - Main.screenPosition, null, Color.White, MathHelper.Pi / 12, new Vector2(12, 16), 1f, spriteEffects, 0);
                }
            }
            else
            {
                ...
                if (illusionBoundPlayer.usedFinalFractal)
                {
                    if (illusionBoundPlayer.finalFractalTier == 1)
                    {
                        ...
                        if (illusionBoundPlayer.usingFinalFractal != 0)
                        {
                            if (useDegree > 0.95f)
                            {
                                spriteBatch.Draw(ModAsset.FinalFractalSwoosh_1.Value, Player.Center + new Vector2(0, -16) - Main.screenPosition, new Rectangle(324, 0, 162, 98), Color.White, -MathHelper.Pi, new Vector2(81, 49), 1f, spriteEffects, 0);
                            }
                            else if (useDegree > 0.8f)
                            {
                                spriteBatch.Draw(ModAsset.FinalFractalSwoosh_1.Value, Player.Center + new Vector2(0, -16) - Main.screenPosition, new Rectangle(162, 0, 162, 98), Color.White, -MathHelper.Pi, new Vector2(81, 49), 1f, spriteEffects, 0);
                            }
                            else if (useDegree > 0.6f)
                            {
                                spriteBatch.Draw(ModAsset.FinalFractalSwoosh_1.Value, Player.Center + new Vector2(0, -16) - Main.screenPosition, new Rectangle(0, 0, 162, 98), Color.White, -MathHelper.Pi, new Vector2(81, 49), 1f, spriteEffects, 0);
                            }
                        }
                        Player.bodyFrame.Y = 56 * (4 - (int)((MathHelper.Pi / 8 - (MathHelper.Pi / 6 * 5 + MathHelper.Pi / 8) * (1 - (float)Math.Pow(Player.itemAnimationMax - illusionBoundPlayer.usingFinalFractal, 2) / (Player.itemAnimationMax * Player.itemAnimationMax))) / (MathHelper.Pi / 8 - (MathHelper.Pi / 6 * 5 + MathHelper.Pi / 8)) * 4));
                    ...
                    if (illusionBoundPlayer.finalFractalTier == 2)
                    {
                        ...
                        if (illusionBoundPlayer.usingFinalFractal != 0)
                        {
                            if (useDegree > 0.66f)
                            {
                                spriteBatch.Draw(ModAsset.FinalFractalSwoosh_2.Value, Player.Center + new Vector2(-64, 0) - Main.screenPosition, new Rectangle(160, 0, 80, 38), Color.White, -MathHelper.Pi, new Vector2(40, 19), 1f, spriteEffects, 0);
                            }
                            else if (useDegree > 0.33f)
                            {
                                spriteBatch.Draw(ModAsset.FinalFractalSwoosh_2.Value, Player.Center + new Vector2(-64, 0) - Main.screenPosition, new Rectangle(80, 0, 80, 38), Color.White, -MathHelper.Pi, new Vector2(40, 19), 1f, spriteEffects, 0);
                            }
                            else if (useDegree > 0.1f)
                            {
                                spriteBatch.Draw(ModAsset.FinalFractalSwoosh_2.Value, Player.Center + new Vector2(-64, 0) - Main.screenPosition, new Rectangle(0, 0, 80, 38), Color.White, -MathHelper.Pi, new Vector2(40, 19), 1f, spriteEffects, 0);
                            }
                        }
                    }
                    if (illusionBoundPlayer.finalFractalTier == 0)
                    {
                        ...
                        if (illusionBoundPlayer.usingFinalFractal != 0)
                        {
                            if (useDegree > 0.66f)
                            {
                                spriteBatch.Draw(ModAsset.FinalFractalSwoosh_3.Value, Player.Center + new Vector2(-48, 0) - Main.screenPosition, new Rectangle(180, 0, 90, 22), Color.White, -MathHelper.Pi, new Vector2(45, 11), 1f, spriteEffects, 0);
                            }
                            else if (useDegree > 0.33f)
                            {
                                spriteBatch.Draw(ModAsset.FinalFractalSwoosh_3.Value, Player.Center + new Vector2(-48, 0) - Main.screenPosition, new Rectangle(90, 0, 90, 22), Color.White, -MathHelper.Pi, new Vector2(45, 11), 1f, spriteEffects, 0);
                            }
                            else if (useDegree > 0.1f)
                            {
                                spriteBatch.Draw(ModAsset.FinalFractalSwoosh_3.Value, Player.Center + new Vector2(-48, 0) - Main.screenPosition, new Rectangle(0, 0, 90, 22), Color.White, -MathHelper.Pi, new Vector2(45, 11), 1f, spriteEffects, 0);
                            }
                        }
                    }
                }
        ...
        public override void AI()
        {
            ...
            FinalFractalPlayer illusionBoundPlayer = Player.GetModPlayer<FinalFractalPlayer>();
            int utime = (int)LogSpiralLibraryMod.ModTime;
